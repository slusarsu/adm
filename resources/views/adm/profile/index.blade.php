            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card profile-header">
                        ...
                        <img class="img-fluid bg-img-cover" src="{{asset('adm_data/assets/images/user-profile/bg-profile.jpg')}}" alt="">
                        ...
                        <div class="userpro-box">
                            ...
                            <div class="img-wrraper">
                                <div class="avatar"><img class="img-fluid" alt="" src="{{asset('adm_data/assets/images/user/7.jpg')}}">
