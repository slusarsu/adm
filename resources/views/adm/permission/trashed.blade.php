                ...
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex">
                        <x-adm.button.btn-link
                            ...
                            :translateText="'adm.permissions'"
                            :iconClass="'fa fa-mail-reply'"
                        />
                        <x-adm.button.bulk-actions
                            :restoreUrl="route('adm.permission-bulk-restore')"
                            :removeUrl="route('adm.permission-bulk-remove')"
                        />
                    </div>
                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <x-adm.button.table-actions
                                                    :restoreUrl="route('adm.permission-restore', $item->id)"
                                                    :removeUrl="route('adm.permission-remove', $item->id)"
                                                />
                                            </td>
                                        </tr>
                                    @endforeach
