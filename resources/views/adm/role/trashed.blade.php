                ...
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex">
                        <x-adm.button.btn-link
                            :url="route('adm.role')"
                            :translateText="'adm.roles'"
                            :iconClass="'fa fa-mail-reply'"
                        />
                        <x-adm.button.bulk-actions
                            :restoreUrl="route('adm.role-bulk-restore')"
                            :removeUrl="route('adm.role-bulk-remove')"
                        />
                    </div>
                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <x-adm.button.table-actions
                                                    :restoreUrl="route('adm.role-restore', $item->id)"
                                                    :removeUrl="route('adm.role-remove', $item->id)"
                                                />
                                            </td>
                                        </tr>
                                    @endforeach
