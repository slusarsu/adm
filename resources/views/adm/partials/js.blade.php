...
<!-- Bootstrap js-->
<script src="{{asset('adm/assets/js/bootstrap/popper.min.js')}}"></script>
<script src="{{asset('adm/assets/js/bootstrap/bootstrap.min.js')}}"></script>
<!-- Plugins JS start-->
@stack('scripts')
<!-- Plugins JS Ends-->
<!-- Theme js-->
...
<script src="{{ asset('adm/assets/js/jquery.colorbox-min.js') }}"></script>
...
<script src="{{asset('adm/assets/js/editor/ckeditor/styles.js')}}"></script>
<script src="{{asset('adm/assets/js/editor/ckeditor/ckeditor.custom.js')}}"></script>