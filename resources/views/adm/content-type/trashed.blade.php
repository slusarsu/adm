                ...
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex">
                        <x-adm.button.btn-link
                            ...
                            :translateText="'adm.content_types'"
                            :iconClass="'fa fa-mail-reply'"
                        />
                        <x-adm.button.bulk-actions
                            :restoreUrl="route('adm.content-type-bulk-restore')"
                            :removeUrl="route('adm.content-type-bulk-remove')"
                        />
                    </div>
                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <x-adm.button.table-actions
                                                    :restoreUrl="route('adm.content-type-restore', $item->id)"
                                                    :removeUrl="route('adm.content-type-remove', $item->id)"
                                                />
                                            </td>
                                        </tr>
                                    @endforeach
