...
@section('content')
    <x-adm.breadcrumb>
        ...
        <li class="breadcrumb-item">{{__('adm.menus')}}</li>
    </x-adm.breadcrumb>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex">
                        <x-adm.button.create :url="route('adm.menu-create')"/>
                        <x-adm.button.bulk-actions
                            :trashUrl="route('adm.menu-bulk-trash')"
                        />
                        <a href="{{route('adm.menu-trashed')}}" class="btn btn-danger mx-1">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <x-adm.button.table-actions
                                                    :editUrl="route('adm.menu-edit', $item->id)"
                                                    :trashUrl="route('adm.menu-trash', $item->id)"
                                                />
                                            </td>
                                        </tr>
                                    @endforeach
