                ...
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex">
                        <x-adm.button.btn-link
                            :url="route('adm.user')"
                            :translateText="'adm.users'"
                            :iconClass="'fa fa-mail-reply'"
                        />
                        <x-adm.button.bulk-actions
                            :restoreUrl="route('adm.user-bulk-restore')"
                            :removeUrl="route('adm.user-bulk-remove')"
                        />
                    </div>
                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <x-adm.button.table-actions
                                                    :restoreUrl="route('adm.user-restore', $item->id)"
                                                    :removeUrl="route('adm.user-remove', $item->id)"
                                                />
                                            </td>
                                        </tr>
                                    @endforeach
