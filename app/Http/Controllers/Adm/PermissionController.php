...
use App\Http\Requests\Adm\Permission\CreateRequest;
use App\Http\Requests\Adm\Permission\UpdateRequest;
...
class PermissionController extends Controller
{
    ...
    public function __construct(PermissionService $baseService)
    {
    ...
    public function index(Request $request): View|Factory|Application
    {
        ...
        return view('adm.permission.index', compact('items', 'trashedCount'));
    }
    ...
    public function trashed(Request $request): Factory|View|Application
    {
        ...
        return view('adm.permission.trashed', compact('items'));
    }
    ...
    public function store(CreateRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('adm.permission-edit', $item->id)->with('success', trans('adm.created_successfully'));
    }
    ...
    public function edit(Request $request, $id): Factory|View|Application
    {
        ...
        return view('adm.permission.edit', compact('item'));
    }
